...
print("The call price via European Binomial is: {0:.4f}".format(price1))

option2 = OptionFacade(theput, binomengine, thedata)
price2 = option2.price()
print("The put price via European Binomial is: {0:.4f}".format(price2))
...
print("The call price via Black-Scholes is: {0:.4f}".format(price3))

bsengine1 = BlackScholesPricingEngine("put", BlackScholesPricer)
option4 = OptionFacade(theput, bsengine1, thedata)
price4 = option4.price()
print("The put price via Black-Scholes is: {0:.4f}".format(price4))
