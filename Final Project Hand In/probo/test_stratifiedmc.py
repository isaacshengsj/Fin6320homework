...
from probo.engine import MonteCarloEngine, StratifiedMonteCarloPricer
...
print("The call price via Stratified Monte Carlo is: {0:.4f} and the standard error is {1:.4f}.".format(price1, stderr1))

option2 = OptionFacade(theput, mcengine, thedata)
price2, stderr2 = option2.price()
print("The put price via Stratified Monte Carlo is: {0:.4f} and the standard error is {1:.4f}.".format(price2, stderr2))
